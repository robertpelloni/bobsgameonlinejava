...
public class InternalTextureLoader {
	...
	private static InternalTextureLoader loader = new InternalTextureLoader();
	...
	public static InternalTextureLoader get()
	{
		...
		if(loader==null)loader = new InternalTextureLoader();
	...
	public Texture getTexture(String resourceName, boolean flipped, int filter) throws IOException {
		InputStream in = Utils.getResourceAsStream(resourceName);
